...
func InitializeApplication() (*Application, error) {
	...
	authHandler := handler.NewAuthHandler(authService, captchaService, passkeyService, initService, dbConfig, configConfig)
	...
	userHandler := handler.NewUserHandler(userService, imageService, authService, passkeyService, configConfig)
	imageHandler := handler.NewImageHandler(imageService)
	routerRouter := router.NewRouter(authMiddleware, rateLimitMiddleware, bodyLimitMiddleware, securityHeadersMiddleware, csrfMiddleware, authHandler, systemHandler, settingsHandler, userHandler, imageHandler)
